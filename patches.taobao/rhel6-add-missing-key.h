...
Subject: Add cropt/signature/key.h which is missing in rhel6 2.6.32-131.12.1
Date:   Wed Aug 31 14:53:56 CST 2011
Patch-mainline: inhouse fix for 2.6.32-131.12.1.el6

In 2.6.32-131.12.1.el6 kernel, cropt/signature/key.h is removed with unknown reason, which
breaks compiling. This patch add the missing file (which is copied from 2.6.32-131.6.1.el6
source tree).
